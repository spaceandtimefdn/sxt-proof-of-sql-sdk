...
mod tests {
    ...
    fn test_verify_attestations_with_hyper_kzg() {
        ...
        let result = verify_attestations(
            ...
            vec![
                hex::decode("e7c9f4d5b48920f6e561b4889bb9bef9874c57e0")
                    .unwrap()
                    .try_into()
                    .unwrap(),
                hex::decode("813d6af4222a6b8ea3237f3a9eb7a9d58ade2ace")
                    .unwrap()
                    .try_into()
                    .unwrap(),
                hex::decode("8c2b9f40a674ca91f8ac5ff30eb17b80d768f209")
                    .unwrap()
                    .try_into()
                    .unwrap(),
            ],
